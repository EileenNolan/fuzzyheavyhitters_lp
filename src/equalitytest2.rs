...
//     E: Debug,
// {
//     let modulus: u128 = 128; // or a different modulus if needed
//     // Encode garbler's input into CRT bundles.
//     let garbler_wires: Vec<CrtBundle<F::Item>> =
//           gb.crt_encode_many(input, modulus)
//             .unwrap();
            
//     // Receive evaluator's corresponding wires (assuming num_tests inputs).
//     let evaluator_wires: Vec<CrtBundle<F::Item>> =
//           gb.crt_receive_many(num_tests, modulus)
//             .unwrap();

//     EQInputs {
//         garbler_wires,   // adjust the type accordingly
//         evaluator_wires, // adjust the type accordingly
//     }
// }
...
//     E: Debug,
// {
//     let modulus: u128 = 128;
    
//     // Receive the garbler's CRT bundles.
//     let garbler_wires: Vec<CrtBundle<F::Item>> =
//           ev.crt_receive_many(num_tests, modulus)
//             .unwrap();

//     // Encode evaluator's input.
//     let evaluator_wires: Vec<CrtBundle<F::Item>> =
//           ev.crt_encode_many(input, modulus)
//             .unwrap();
